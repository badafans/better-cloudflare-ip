...
4.内置的 anycast ip 数量为 884992 个，每次测试提取其中的256分之1，运气好的话一分多钟就能获取到自己想要的优选 IP
...
5.内置的 anycast ip 数量为 884992 个，每次测试提取其中的256分之1，运气好的话三分多钟就能获取到自己想要的优选 IP
...
5.内置的 anycast ip 数量为 884992 个，每次测试提取其中的256分之1，运气好的话六分多钟就能获取到自己想要的优选 IP
